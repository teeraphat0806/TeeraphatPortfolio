      ...
      <Container>
        <div className="space-y-10">
          <Reveal>
            <SectionHeading
              eyebrow="Projects"
              title="Selected work built for real business workflows and automation."
              description="Selected projects centered on real business workflows and automation, showcasing systems designed to solve operational challenges and improve efficiency."
            />
          </Reveal>
